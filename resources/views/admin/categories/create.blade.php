                        ...
                        <div class="col-md-12">
                            <div class="card card-outline mt-2">
                                <div class="px-4 py-2 border d-flex justify-content-between align-items-center">
                                    <div>
                                        <h3 class="card-title">Создать новый категории</h3>
                                    </div>
                                    <div>
                                        <div class="d-flex justify-content-end">
                                            <button type="submit" class="btn btn-sm btn-primary">
                                                <i class="fas fa-plus-circle"></i> Создать категории
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="tab-content" id="languageTabsContent">
                                                    ...
                                                    <div class="tab-pane fade show active" id="uzbek" role="tabpanel" aria-labelledby="uzbek-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name_uz" name="name_uz" placeholder="Введите название бренда на узбекском">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="description_uz">Описание (Узбекский)</label>
                                                            <textarea id="summernote_uz" class="form-control" name="description_uz" placeholder="Введите описание бренда на узбекском"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- Русский -->
                                                    <div class="tab-pane fade" id="russian" role="tabpanel" aria-labelledby="russian-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name_ru" name="name_ru" placeholder="Введите название бренда на русском">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="description_ru">Описание (Русский)</label>
                                                            <textarea id="summernote_ru" class="form-control" name="description_ru" placeholder="Введите описание бренда на русском"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- Английский -->
                                                    <div class="tab-pane fade" id="english" role="tabpanel" aria-labelledby="english-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name_en" name="name_en" placeholder="Введите название бренда на английском">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="description_en">Описание (Английский)</label>
                                                            <textarea id="summernote_en" class="form-control" name="description_en" placeholder="Введите описание бренда на английском"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- Турецкий -->
                                                    <div class="tab-pane fade" id="turkish" role="tabpanel" aria-labelledby="turkish-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name_tr" name="name_tr" placeholder="Введите название бренда на турецком">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="description_tr">Описание (Турецкий)</label>
                                                            <textarea id="summernote_tr" class="form-control" name="description_tr" placeholder="Введите описание бренда на турецком"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
