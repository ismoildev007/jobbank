                        ...
                        <form action="{{ route('categories.update', [$category->id]) }}" method="POST"
                            ...
                            <ul class="nav nav-tabs mb-4" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#uz" role="tab"
                                       aria-selected="true">O‘zbek</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-pane fade show active" id="uz" role="tabpanel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea id="description_uz" name="description_uz" class="form-control editor"
                                                  rows="5">{{ old('description_uz', $category->description_uz) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea id="description_ru" name="description_ru" class="form-control editor"
                                                  rows="5">{{ old('description_ru', $category->description_ru) }}</textarea>
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea id="description_en" name="description_en" class="form-control editor"
                                                  rows="5">{{ old('description_en',$category->description_en) }}</textarea>
