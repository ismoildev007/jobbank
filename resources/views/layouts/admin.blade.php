...
<html lang="en" class=" layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-skin="default"
      data-bs-theme="light" data-assets-path="/admin/assets/" data-template="vertical-menu-template">
<head>
    <meta charset="utf-8">
    <meta name="viewport"
    ...
    <!-- Canonical SEO -->
    <meta name="keywords"
          content="Materialize bootstrap dashboard, Materialize bootstrap 5 dashboard, themeselection, html dashboard, web dashboard, frontend dashboard, responsive bootstrap theme">
    ...
    <meta property="og:image"
          content="https://ts-assets.b-cdn.net/pi-assets/materialize/landing-page/materialize-hero-image.png">
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="/admin/assets/vendor/css/pages/cards-statistics.css">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
            ...
            <div class="app-brand demo ">
              ...
              <span class="app-brand-logo demo">
                  <img src="/admin/assets/img/logo.png" alt="" width="50">
                </span>
                    <span class="app-brand-text demo menu-text fw-semibold ms-2">Jobbank Uz</span>
                </a>
