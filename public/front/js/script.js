...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userPhoneInput) {
        const iti = intlTelInput(userPhoneInput, {
            ...
            initialCountry: "uz", // Set default country to Uzbekistan
            onlyCountries: ["uz"] // Restrict dropdown to only Uzbekistan
        });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userPhoneInput) {
        const iti = intlTelInput(userPhoneInput, {
			utilsScript: window.location.origin + "/assets/plugins/intltelinput/js/utils.js",
            separateDialCode: true,
          	onlyCountries: ["uz"], // Restrict to Uzbekistan only
            initialCountry: "uz" // Set Uzbekistan as default country
        });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (userPhoneInput) {
        ...
        // document.querySelector("#staffsForm").addEventListener("submit", function (event) {
        //     event.preventDefault();
